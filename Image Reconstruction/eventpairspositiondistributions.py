# -*- coding: utf-8 -*-
"""
Created on Thu Mar 23 15:42:09 2023
...
df = pd.read_parquet('15thMarchSA.parquet')
...
# d_1a_1s = d_1a.query('`scatter channel` == 0') #events that absorb in channel 0 that scattered in channel 0 etc
# d_1a_2s = d_1a.query('`scatter channel` == 1')
# d_1a_3s = d_1a.query('`scatter channel` == 2')
# d_1a_4s = d_1a.query('`scatter channel` == 3')
# d_1a_5s = d_1a.query('`scatter channel` == 4')
# d_1a_6s = d_1a.query('`scatter channel` == 5')
# d_1a_7s = d_1a.query('`scatter channel` == 6')
# d_1a_8s = d_1a.query('`scatter channel` == 7')
...
table1 = [['Scattering Detector', 'Absorbing Detector', 'Number of Events', 'Highest Scattering Point', 'Highest Absorption Point'], 
...
with open('tableofeventdistributions.txt', 'w') as f:
    f.write(tabulate(table1))

#desnity of scattering points in each detector for scatter-absorption


#desnity of scattering points in each detector for scatter-scatter


#desnity of absorption points in each detector for scatter-absorption


#density of scattering points for when absorption locations are absorbed in channel 4


#density of scattering points for when absorption locations are absorbed in channel 5


#density of scattering points for when absorption locations are absorbed in channel 6


#density of scattering points for when absorption locations are absorbed in channel 7


#density of absorption points for when scattering locations are scattered in channel 0


#density of absorption points for when scattering locations are scattered in channel 1


#density of absorption points for when scattering locations are scattered in channel 2


#density of absorption points for when scattering locations are scattered in channel 3