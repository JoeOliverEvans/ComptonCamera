...
def process_2d(matrix, dataframe):
    ...
    ax[0].set_xticklabels(np.array([0, 20, 40, 60, 80, 100, 120, 140, 160]) + graphxoffset)
    ax[0].set_yticks(np.array([0, 20, 40, 60, 80, 100, 120, 140, 160])-1)
    ax[0].set_yticklabels(np.array([0, 20, 40, 60, 80, 100, 120, 140, 160][::-1]) + graphyoffset)
...
if __name__ == '__main__':
    # get file data
    file1 = r"SavedVoxelCubes\posabsorptionscatterExtendedSource.parquet13-04-2023 11-59-59+(160, 160, 80).txt"
    file2 = r"SavedVoxelCubes\posabsorptionscatterExtendedSource.parquet13-04-2023 11-59-59+(160, 160, 80).txt"
