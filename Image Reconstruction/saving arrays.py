...
if __name__ == '__main__':
    # get file data
    file1 = r"SavedVoxelCubes\posabsorptionscatter24thMar2SourceForReal.parquet08-04-2023 16-20-11+(160, 160, 80).txt"
    file2 = r"SavedVoxelCubes\posscatterscatter24thMar2SourceForReal.parquet08-04-2023 16-16-07+(160, 160, 80).txt"
