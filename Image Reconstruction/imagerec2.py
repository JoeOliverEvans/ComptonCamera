...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr  4 19:26:13 2023
...
if __name__ == '__main__':
    ...
    pairs = []
    file_name = '/Users/amberjones/Documents/IRdata/posscatterscatter29-03-2023 12-42-33.parquet'
    df = pd.read_parquet(fr'/Users/amberjones/Documents/IRdata/posscatterscatter29-03-2023 12-42-33.parquet')
    ...
    for x in range(2000):
        ...
        pairs.append(DetectionPair(np.array(row[1]) + np.array([40, 40, z_plane-source_z]), np.array(row[3]) + np.array([40, 40, z_plane-source_z]), 662, row[0] * 1000))
    ...
    plot_3d(voxel_cube[:, :, :], view_only_intersections=True)